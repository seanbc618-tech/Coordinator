...
from local_cli_coordinator.db import init_db, MIGRATIONS_DIR, connect
...
class TestDigest(unittest.TestCase):
    ...
    def test_digest_cli_creates_digest_file(self):
        """CLI-level test: invoke digest command and verify output file is created."""
        with tempfile.TemporaryDirectory() as tmp:
            ...
            self.assertIn("task-x", content)

    def test_digest_cli_fails_without_database(self):
        with tempfile.TemporaryDirectory() as tmp:
